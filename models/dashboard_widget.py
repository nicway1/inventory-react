...
DEFAULT_DASHBOARD_LAYOUT = {
    'DEVELOPER': [
        ...
        {'widget_id': 'recent_activities', 'position': 7, 'size': 'medium', 'config': {}},
        {'widget_id': 'shipments_list', 'position': 8, 'size': 'large', 'config': {}},
        {'widget_id': 'system_management', 'position': 9, 'size': 'large', 'config': {}},
        {'widget_id': 'user_overview', 'position': 10, 'size': 'small', 'config': {}},
    ],
    'SUPER_ADMIN': [
        {'widget_id': 'inventory_stats', 'position': 0, 'size': 'small', 'config': {}},
        {'widget_id': 'ticket_stats', 'position': 1, 'size': 'small', 'config': {}},
        ...
        {'widget_id': 'view_inventory', 'position': 4, 'size': 'small', 'config': {}},
        {'widget_id': 'weekly_tickets_chart', 'position': 5, 'size': 'medium', 'config': {}},
        {'widget_id': 'queue_stats', 'position': 6, 'size': 'medium', 'config': {}},
        {'widget_id': 'recent_activities', 'position': 7, 'size': 'medium', 'config': {}},
        {'widget_id': 'shipments_list', 'position': 8, 'size': 'large', 'config': {}},
        {'widget_id': 'system_management', 'position': 9, 'size': 'large', 'config': {}},
        {'widget_id': 'user_overview', 'position': 10, 'size': 'small', 'config': {}},
    ...
    'SUPERVISOR': [
        {'widget_id': 'import_manager', 'position': 0, 'size': 'small', 'config': {}},
        {'widget_id': 'view_tickets', 'position': 1, 'size': 'small', 'config': {}},
        {'widget_id': 'view_inventory', 'position': 2, 'size': 'small', 'config': {}},
        {'widget_id': 'customer_stats', 'position': 3, 'size': 'small', 'config': {}},
        {'widget_id': 'report_issue', 'position': 4, 'size': 'small', 'config': {}},
        {'widget_id': 'knowledge_base_link', 'position': 5, 'size': 'small', 'config': {}},
        {'widget_id': 'queue_stats', 'position': 6, 'size': 'medium', 'config': {}},
        {'widget_id': 'shipments_list', 'position': 7, 'size': 'large', 'config': {}},
    ],
    'COUNTRY_ADMIN': [
        {'widget_id': 'quick_actions', 'position': 0, 'size': 'small', 'config': {}},
        {'widget_id': 'view_inventory', 'position': 1, 'size': 'small', 'config': {}},
        {'widget_id': 'view_tickets', 'position': 2, 'size': 'small', 'config': {}},
        {'widget_id': 'shipments_list', 'position': 3, 'size': 'large', 'config': {}},
    ],
    'CLIENT': [
        {'widget_id': 'ticket_stats', 'position': 0, 'size': 'small', 'config': {}},
        {'widget_id': 'knowledge_base_link', 'position': 1, 'size': 'small', 'config': {}},
        {'widget_id': 'view_tickets', 'position': 2, 'size': 'small', 'config': {}},
    ]
}
