...
# =============================================================================
# BLOG POST DATA (scraped from truelog.com.sg/blog/)
# =============================================================================
...
def api_admin_import_truelog():
    """Import TrueLog blog posts from scraped data (uses module-level BLOG_POSTS)"""
    db = SessionLocal()
    try:
        # Uses BLOG_POSTS defined at module level
