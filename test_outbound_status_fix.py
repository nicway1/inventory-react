...
def test_outbound_status_update():
    print("=== TESTING OUTBOUND STATUS UPDATE ===\n")
    ...
    try:
        ...
        if not tickets:
            print("❌ No tickets with outbound tracking found")
            return
        ...
        print(f"   New status: {fresh_ticket.shipping_status}")
        ...
        print("✅ Status reset for testing")
