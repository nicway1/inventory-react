...
def migrate():
    """Add ticket permission columns to the permissions table."""
    try:
        ...
        cursor.execute("""
            UPDATE permissions 
            SET can_view_tickets=1, 
                can_edit_tickets=1, 
                can_delete_tickets=1, 
                can_delete_own_tickets=1, 
        ...
        # Commit the changes
        conn.commit()
        print("Successfully added ticket permission columns and set default values")
