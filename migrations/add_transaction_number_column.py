#!/usr/bin/env python
"""
Migration script to add transaction_number column to accessory_transactions table
"""
import sqlite3
import os
...
def run_migration():
    ...
    try:
        ...
        if 'transaction_number' not in columns:
            print("Adding transaction_number column...")
            cursor.execute('''
                ALTER TABLE accessory_transactions 
                ADD COLUMN transaction_number VARCHAR(100)
            ''')
